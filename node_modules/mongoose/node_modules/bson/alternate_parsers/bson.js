 ...
 * @param {Boolean} serializeFunctions serialize the js functions **(default:false)**.
...
BSON.serialize = function(object, checkKeys, asBuffer, serializeFunctions) {
  ...
  if(object == null || typeof object != 'object' || Array.isArray(object))
    throw new Error("Only js objects supported");
  ...
  while(true) {
    ...
    switch(elementType) {
      ...
      case BSON.BSON_DATA_REGEXP:
        ...
        // For each option add the corresponding one for js

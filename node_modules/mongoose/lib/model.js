 ...
 *
 * Sometimes you need to query for things in mongodb using a JavaScript expression. You can do so via `find({ $where: js })`, or you can use the mongoose shortcut method $where via a Query chain or from your mongoose Model.
 *
 *     Blog.$where('this.username.indexOf("val") !== -1').exec(function (err, docs) {});
 *
 * @param {String|Function} argument is a js string or anonymous function
 * @method $where
 * @memberOf Model
 * @return {Query}
 ...
 * - The documents returned are plain js objects, not mongoose documents (since any shape of document can be returned).
